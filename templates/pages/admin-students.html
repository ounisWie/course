...
<link rel="stylesheet" href="../assets/css/theme.min.css">
  <title>Students | Geeks - Academy Admin Template</title>
</head>
    ...
    <nav class="navbar-vertical navbar">
      <div class="nav-scroller">
        ...
        <ul class="navbar-nav flex-column" id="sideNavbar">
          ...
          <li class="nav-item">
            ...
            <div id="navCourses" class="collapse" data-parent="#sideNavbar">
              <ul class="nav flex-column">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="admin-course-category.html">Courses Category
                  </a>
                </li>
                <li class="nav-item">
          ...
          <!-- Nav item  -->
          <li class="nav-item">
            <a class="nav-link active" href="#!" data-toggle="collapse" data-target="#navProfile" aria-expanded="true"
              aria-controls="navProfile">
              <i class="nav-icon fe fe-user mr-2"></i>User
            </a>
            <div id="navProfile" class="collapse show" data-parent="#sideNavbar">
              <ul class="nav flex-column">
                <li class="nav-item">
          ...
          <!-- Nav item  -->
          <li class="nav-item">
            <a class="nav-link" href="#!" data-toggle="collapse" data-target="#navAuthentication" aria-expanded="false"
          ...
          <!-- Nav item  -->
          <li class="nav-item">
            <a class="nav-link" href="#!" data-toggle="collapse" data-target="#navMenuLevel" aria-expanded="false"
            ...
            <div id="navMenuLevel" class="collapse" data-parent="#sideNavbar">
              <ul class="nav flex-column">
                <li class="nav-item">
                  <a class="nav-link" href="#!" data-toggle="collapse" data-target="#navMenuLevelSecond"
                ...
                <li class="nav-item">
                  <a class="nav-link" href="#!" data-toggle="collapse" data-target="#navMenuLevelThree"
                  ...
                  <div id="navMenuLevelThree" class="collapse" data-parent="#navMenuLevel">
                    <ul class="nav flex-column">
                      <li class="nav-item">
                        <a class="nav-link" href="#!" data-toggle="collapse" data-target="#navMenuLevelThreeOne"
                          aria-expanded="false" aria-controls="navMenuLevelThreeOne">NavItem 1
                        </a>
          ...
          <li class="nav-item">
            <a class="nav-link" href="../docs/changelog.html">
              ...
              <span class="badge badge-primary ml-2">1.0.1</span>
            </a>
          </li>
        </ul>
        <!-- Card  -->
                  ...
                  <ul class="list-group list-group-flush notification-list-scroll">
                    <li class="list-group-item bg-light">
                      <div class="row">
                        ...
                        <div class="col-auto text-center">
                          <a href="#!" class="badge-dot badge-info" data-toggle="tooltip" data-placement="top" title=""
                            data-original-title="Mark as read">
                          </a>
                          <div>
                            <a href="#!" class="bg-transparent" data-toggle="tooltip" data-placement="top" title=""
                    ...
                    <li class="list-group-item">
                      <div class="row">
                        ...
                        <div class="col-auto text-center">
                          <a href="#!" class="badge-dot badge-secondary" data-toggle="tooltip" data-placement="top"
                            title="" data-original-title="Mark as unread">
                          </a>
                        </div>
                      </div>
                    </li>
                      ...
                      <div class="card mb-4">
                        ...
                        <div class="card-body">
                          <div class="text-center">
                            ...
                            <h4 class="mb-0">Esther Howard</h4>
                            <p class="mb-0">
                              <i class="fe fe-map-pin mr-1 font-size-xs"></i>India
                            </p>
                          </div>
                          <div class="d-flex justify-content-between border-bottom py-2 mt-6">
                            <span>Payments</span>
                      ...
                      <div class="card mb-4">
                        ...
                        <div class="card-body">
                          <div class="text-center">
                            ...
                            <p class="mb-0">
                              <i class="fe fe-map-pin mr-1 font-size-xs"></i>United Kingdom
                            </p>
                          </div>
                          <div class="d-flex justify-content-between border-bottom py-2 mt-6">
                            <span>Payments </span>
                      ...
                      <div class="card mb-4">
                        ...
                        <div class="card-body">
                          <div class="text-center">
                            ...
                            <h4 class="mb-0">Esther Howard</h4>
                            <p class="mb-0">
                              <i class="fe fe-map-pin mr-1 font-size-xs"></i>Netherland
                            </p>
                          </div>
                          <div class="d-flex justify-content-between border-bottom py-2 mt-6">
                            <span>Payments</span>
                      ...
                      <div class="card mb-4">
                        ...
                        <div class="card-body">
                          <div class="text-center">
                            ...
                            <p class="mb-0">
                              <i class="fe fe-map-pin mr-1 font-size-xs"></i>South Africa
                            </p>
                          </div>
                          <div class="d-flex justify-content-between border-bottom py-2 mt-6">
                            <span>Payments</span>
                      ...
                      <div class="card mb-4">
                        ...
                        <div class="card-body">
                          <div class="text-center">
                            ...
                            <p class="mb-0">
                              <i class="fe fe-map-pin mr-1 font-size-xs"></i>New York
                            </p>
                          </div>
                          <div class="d-flex justify-content-between border-bottom py-2 mt-6">
                            <span>Payments</span>
                      ...
                      <table class="table mb-0 text-nowrap">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td class="align-middle">7 Courses</td>
                            <td class="align-middle">12 Aug, 2020</td>
                            <td class="align-middle">$14,944</td>
                            <td class="align-middle">United State</td>
                            <td class="align-middle">
                              <a href="#!" class="text-muted" data-toggle="tooltip" data-placement="top"
                                title="Message"><i class="fe fe-mail"></i></a>
                            </td>
                          ...
                          <tr>
                            ...
                            <td class="align-middle">5 Courses</td>
                            <td class="align-middle">5 Aug, 2020</td>
                            <td class="align-middle">$6,845</td>
                            <td class="align-middle">India</td>
                            <td class="align-middle">
                              <a href="#!" class="text-muted" data-toggle="tooltip" data-placement="top"
                                title="Message"><i class="fe fe-mail"></i></a>
                            </td>
                          ...
                          <tr>
                            ...
                            <td class="align-middle">1 Aug, 2020</td>
                            <td class="align-middle">$8,230</td>
                          ...
                          <tr class="border-bottom">
                            ...
                            <td class="align-middle">2 Courses</td>
                            <td class="align-middle">28 July, 2020</td>
                            <td class="align-middle">$2,140</td>
                            <td class="align-middle">Africa</td>
                            <td class="align-middle">
                              <a href="#!" class="text-muted" data-toggle="tooltip" data-placement="top"
                                title="Message"><i class="fe fe-mail"></i></a>
                            </td>
